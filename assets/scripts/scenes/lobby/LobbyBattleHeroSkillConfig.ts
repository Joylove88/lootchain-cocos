...
const BATTLE_HERO_SKILL_CONFIG: Record<string, BattleHeroSkillProfile> = {
  ...
  UR_ARTHAS: { effects: [{ type: 'stun', baseChance: 0.3, magnitude: 1.2 }, { type: 'splash', baseChance: 0.42, magnitude: 0.7 }, { type: 'reflect', baseChance: 0.36, magnitude: 0.5 }, { type: 'atkUp', baseChance: 1, magnitude: 0.3 }] }, // UR 战士·T0(sql/110 增强)
  ...
  SSR_LIVIA: { effects: [{ type: 'splash', baseChance: 0.36, magnitude: 0.65 }, { type: 'freeze', baseChance: 0.26, magnitude: 1.5 }, { type: 'truePierce', baseChance: 0.32, magnitude: 1 }, { type: 'atkUp', baseChance: 1, magnitude: 0.24 }] }, // SSR 法师·T0(sql/110 增强)
  ...
  SR_SNIPER_05: { effects: [{ type: 'truePierce', baseChance: 0.4, magnitude: 1 }, { type: 'atkUp', baseChance: 1, magnitude: 0.2 }] }, // SR 射手·T0(sql/110 增强)
  ...
  R_SCOUT_03: { effects: [{ type: 'truePierce', baseChance: 0.36, magnitude: 1 }, { type: 'atkUp', baseChance: 1, magnitude: 0.15 }] }, // R 刺客·T0(sql/110 增强)
