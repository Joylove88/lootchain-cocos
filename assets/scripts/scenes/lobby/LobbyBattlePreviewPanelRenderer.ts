...
export class LobbyBattlePreviewPanelRenderer {
  ...
  private renderManualUltCutIn(field: Node, unit: BattlePresentationUnitSnapshot): void {
    ...
    bandGraphics.fillColor = rgba(60, 12, 10, 150);
    bandGraphics.rect(-width * 0.34, -bandH / 2, width * 0.68, bandH);
    bandGraphics.fill();
    bandGraphics.fillColor = rgba(60, 12, 10, 70);
    bandGraphics.rect(-width * 0.5, -bandH / 2, width * 0.16, bandH);
    bandGraphics.rect(width * 0.34, -bandH / 2, width * 0.16, bandH);
    bandGraphics.fill();
    bandGraphics.fillColor = rgba(230, 186, 100, 200);
    bandGraphics.rect(-width * 0.34, bandH / 2 - 2, width * 0.68, 2);
    bandGraphics.rect(-width * 0.34, -bandH / 2, width * 0.68, 2);
    bandGraphics.fill();
